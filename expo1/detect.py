...
cap = cv2.VideoCapture(r"E:\research\urban\dataset\video1.mp4")
# get the video frame height and width
frame_width = int(cap.get(3))
frame_height = int(cap.get(4))
save_name = r"E:\research\urban\dataset\out_video1.mp4"
...
background = get_background(r"E:\research\urban\dataset\video1.mp4")
